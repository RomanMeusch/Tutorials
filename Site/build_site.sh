...
cd EScript
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wno-inconsistent-missing-override" -DBUILD_ESCRIPT_APPLICATION=ON -DBUILD_ESCRIPT_TEST=OFF -DBUILD_SHARED_LIBS=ON . && make -j2
cd ..

git clone https://github.com/MeisterYeti/E_XML.git E_XML &> /dev/null
cd E_XML
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wno-inconsistent-missing-override" . && make -j2
cd ..
...
cp ../../Tools/doc/gui_config.h src/modules/GUI/config.h # normally generated by cmake
